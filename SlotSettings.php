...
namespace VanguardLTE\Games\CloverStonesNG
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $context = null)
        {
            ...
            $user = $context ? new \VanguardLTE\Stateless\User($context->user) : \VanguardLTE\User::lockForUpdate()->find($this->playerId);
            $this->user = $user;
            $this->shop_id = $user->shop_id;
            $gamebank = $context ? new \VanguardLTE\Stateless\GameBank($context->bank) : \VanguardLTE\GameBank::where(['shop_id' => $this->shop_id])->lockForUpdate()->get();
            $game = $context ? new \VanguardLTE\Stateless\Game($context->game) : \VanguardLTE\Game::where(['name' => $this->slotId, 'shop_id' => $this->shop_id])->lockForUpdate()->first();
            $this->shop = $context ? new \VanguardLTE\Stateless\Shop($context->shop) : \VanguardLTE\Shop::find($this->shop_id);
            $this->game = $game; if ($context) $this->game->gamebank_instance = $gamebank;
            ...
            $this->hideButtons = [];
            $this->jpgs = $context ? collect($context->jpgs)->map(function($j){ return new \VanguardLTE\Stateless\JPG($j); }) : \VanguardLTE\JPG::where('shop_id', $this->shop_id)->lockForUpdate()->get();
            $this->Line = [
                1, 
                2, 
                3, 
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
        {
            ...
            $this->game->refresh();
            // Stateless: Use get_gamebank directly
